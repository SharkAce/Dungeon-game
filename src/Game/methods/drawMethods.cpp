...
void Game::drawFramerate() {
	this->writeToScreen(
		std::to_string((int)this->framerate),
		this->window.getSize().x - 40.f,18.f, 
		this->default_text
	);
};
...
void Game::drawHelpMenu(){
	this->writeToScreen(
		"How to play:",
		this->window.getSize().x/2.0f,
		this->window.getSize().y/3.0f+(40.f*-1.f), 
		this->default_text
	);
	this->writeToScreen(
		"The sword follows the cursor",
		this->window.getSize().x/2.0f,
		this->window.getSize().y/3.0f+(40.f*1.f), 
		this->default_text
	);
	this->writeToScreen(
		...
		this->window.getSize().x/2.0f,
		this->window.getSize().y/3.0f+(40.f*2.f), 
		this->default_text
	);
	this->writeToScreen(
		"W,A,S,D for moving",
		this->window.getSize().x/2.0f,
		this->window.getSize().y/3.0f+(40.f*3.f), 
		this->default_text
	);
	this->writeToScreen(
...
void Game::drawWinScreen(){
	this->writeToScreen(
		"Thanks  for  playing\nPress 'r' to restart", 
		this->window.getSize().x/2.0f,
		this->window.getSize().y/2.0f-90.f, 
		this->default_text
	);
